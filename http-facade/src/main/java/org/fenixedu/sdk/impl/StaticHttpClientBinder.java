...
public class StaticHttpClientBinder implements HttpClientFactoryBinder {
    ...
    private StaticHttpClientBinder() {
        throw new UnsupportedOperationException("This code should have never made it into http-facade.jar");
    }

    @Override
    public IHttpClientFactory getHttpClientFactory() {
        throw new UnsupportedOperationException("This code should never make it into http-facade.jar");
    }
