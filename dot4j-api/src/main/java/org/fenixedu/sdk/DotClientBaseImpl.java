...
public abstract class DotClientBaseImpl implements DotClientBase {

    private static final Logger logger = LoggerFactory.getLogger(DotClientBaseImpl.class);
    ...
    public OAuthAuthorization refreshAccessToken(OAuthAuthorization authorization) {
        ...
        if (DotEndpoint.OAUTH_REFRESH_ACCESS_TOKEN.getResponseClass().equals(JsonObject.class)) {
