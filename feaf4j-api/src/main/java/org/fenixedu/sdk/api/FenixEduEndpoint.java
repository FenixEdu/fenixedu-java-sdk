...
public enum FenixEduEndpoint {
    ...
    ABOUT("about", Scope.PUBLIC, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class), DOMAIN_MODEL("domainModel",
            ...
            MediaType.APPLICATION_JSON, JsonArray.class), PERSON("person", Scope.PERSONAL, HttpMethod.GET,
            MediaType.APPLICATION_JSON, JsonObject.class), PERSON_CALENDAR_CLASSES("person/calendar/classes", Scope.SCHEDULE,
            HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class), PERSON_CALENDAR_EVALUATIONS(
            "person/calendar/evaluations", Scope.SCHEDULE, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class),
    PERSON_COURSES("person/courses", Scope.CURRICULAR, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class),
    PERSON_CURRICULUM("person/curriculum", Scope.CURRICULAR, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonArray.class),
