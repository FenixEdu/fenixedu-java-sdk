...
public enum FenixEduEndpoint {
    ...
    ABOUT("about", Scope.PUBLIC, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class), DOMAIN_MODEL("domainModel",
            ...
            Scope.PUBLIC, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonArray.class), COURSE_SCHEDULE("course/%s/schedule",
            Scope.PUBLIC, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class), COURSE_STUDENTS("course/%s/students",
            Scope.PUBLIC, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class), DEGREES("degrees", Scope.PUBLIC,
            HttpMethod.GET, MediaType.APPLICATION_JSON, JsonArray.class), DEGREE("degrees/%s", Scope.PUBLIC, HttpMethod.GET,
            MediaType.APPLICATION_JSON, JsonObject.class), DEGREE_COURSES("degrees/%s/courses", Scope.PUBLIC, HttpMethod.GET,
            MediaType.APPLICATION_JSON, JsonArray.class), PERSON("person", Scope.PUBLIC, HttpMethod.GET,
            MediaType.APPLICATION_JSON, JsonObject.class), PERSON_CALENDAR_CLASSES("person/calendar/classes", Scope.PUBLIC,
            HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class), PERSON_CALENDAR_EVALUATIONS(
            "person/calendar/evaluations", Scope.PUBLIC, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class),
    PERSON_COURSES("person/courses", Scope.PUBLIC, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class),
    PERSON_CURRICULUM("person/curriculum", Scope.PUBLIC, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonArray.class),
    PERSON_EVALUATIONS("person/evaluations", Scope.PUBLIC, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonArray.class),
    PERSON_EVALUATION("person/evaluations/%s", Scope.PUBLIC, HttpMethod.PUT, MediaType.APPLICATION_JSON, JsonObject.class),
    PERSON_PAYMENTS("person/payments", Scope.PUBLIC, HttpMethod.GET, MediaType.APPLICATION_JSON, JsonObject.class), SPACES(
